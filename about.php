  ...
  <!-- about section content -->
    <section id="pricing" aria-label="Pricing" class="bg-slate-900 py-20 sm:py-32">
                ...
                <div class="space-y-4">
                  <div class="space-y-2">
                    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                      <span class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-600">Who We Are</span>
                    </h1>
                  </div>
                  <p class="text-base text-black sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
      ...
      <section class="mt-10 mb-10 bg-gradient-to-br from-slate-200 to-gray-500 py-16 md:py-32">
        <div class="container mx-auto px-4 md:px-8 text-center">
          <h1 class="text-white font-bold text-4xl md:text-6xl leading-tight mb-6">
            SunSolar Energy is part of SHV Energy
          </h1>
          <p class="text-white text-lg md:text-2xl mb-12">
            SHV Energy is a leading global distributor of off-grid energy with 30 million customers across 4 continents. It is a wholly owned subsidiary of SHV, a global 125-year-old family business with a portfolio of companies in over 60 countries. SunSource Energy is proud to bring the stability, global view and long-term approach of SHV to India and other regions of focus.
          </p>
        </div>
      </section>
      ...
      <div class="relative m-16">
        <button class="absolute py-1 px-3 -left-8 -top-2 border border-black shadow-[4px_4px_1px_rgb(0,0,0)] bg-orange-600 text-white font-bold">
          OUR MISSION
        </button>
        <div class="shadow-[4px_4px_1px_rgb(234,88,12)] p-8 border text-black border-black">
          The <span class="font-mono text-orange-600 font-bold">message</span> variable is a Laravel reserved word within this email context, so you should avoid using that as a field handle if you intend on using the email feature.
        </div>
      </div>
    
      <!-- Vision Card -->
      <div class="relative m-16">
        <span class="absolute -z-10 w-full h-full inset-1 bg-orange-500 rounded-xl"></span>
        <button class="absolute py-1 z-10 px-3 -left-8 -top-2 shadow-[4px_4px_1px_rgb(0,0,0)] bg-orange-600 text-white font-bold">
          OUR VISION
        </button>
        <div class="p-8 border text-black border-black shadow-[4px_4px_1px_rgb(234,88,12)] bg-white rounded-xl z-20">
          The <span class="font-mono text-orange-600 font-bold">message</span> variable is a Laravel reserved word within this email context, so you should avoid using that as a field handle if you intend on using the email feature.
        </div>
      </div>
